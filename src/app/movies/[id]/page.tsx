            ...
            <div className="relative z-20 py-4 flex gap-6 flex-col pb-10 px-10 bg-imdb-black/80">
                <div className="flex gap-6 py-4 px-4">
                    ...
                    <div className="w-1/5 flex flex-col items-center gap-4">
                        <Image src={movie.poster_path ? `https://image.tmdb.org/t/p/w500${movie.poster_path}` : "/no-image-available.png"} alt={movie.title} width={225} height={300} />
                        ...
                        <div className="w-full bg-red-600 h-2 rounded">
                            <div className="bg-green-600 h-2 rounded" style={{ width: `${(movie.vote_average / 10) * 100}%` }}></div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 text-sm text-white">
                        ...
                        <div>
                            ...
                            <p>Production Companies: {movie.production_countries?.map((c: { name: any }) => c.name).join(", ")}</p>
                        </div>
